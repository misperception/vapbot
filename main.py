  ...
  if ctx.channel.is_nsfw():
    ...
    if shot < 6:
      ...
      if roundtwo < 6:
        ...
        baseURL = "https://e621.net/posts.json?page={page}&limit=1"
        ...
        baseURL = "https://e621.net/posts.json?page={page}&limit=1&tags={tags}"
        tag = ["watersports", "omorashi", "scat", "gore", "vore", "femboy", "anal_vore", "diapers"]
